      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {activeTab === 'resources' && (
          <div className="space-y-12">
            {/* CONTINUE Section */}
            <section>
              <h2 className="font-judson text-3xl font-bold text-gray-900 mb-6 text-center">CONTINUE TEACHING</h2>
            ...
            {/* ASSIGNED Section */}
            <section>
              <h2 className="font-judson text-3xl font-bold text-gray-900 mb-6 text-center">ASSIGNED TEACHING</h2>
              <div className="bg-white rounded-2xl p-6 border border-gray-200">
                <div className="grid grid-cols-3 gap-4">
