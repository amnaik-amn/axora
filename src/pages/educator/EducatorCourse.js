...
import { ArrowLeft, Play, MessageCircle, Plus, Save, X } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <header className="bg-[#AC5757] sticky top-0 z-40">
          <div className="flex items-center justify-between px-6 h-24">
            ...
            <h1 className="font-oswald font-medium text-white text-[70px]">{selectedCourse.title}</h1>
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#AC5757] mb-2">{selectedCourse.enrolledStudents}</div>
                <div className="text-gray-600">Enrolled Students</div>
                      </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#AC5757] mb-2">{selectedCourse.credits}</div>
                <div className="text-gray-600">Credits</div>
                    </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#AC5757] mb-2">{selectedCourse.duration}</div>
                <div className="text-gray-600">Duration</div>
                </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-[#AC5757] mb-2">{selectedCourse.semester}</div>
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div 
                ...
                className="bg-white rounded-xl p-6 border-2 border-dashed border-gray-300 text-center cursor-pointer hover:border-[#AC5757] hover:bg-gray-50 transition-colors"
              >
